void Main(){
  while (true)
  {
    ...
    if(bc.ReturnColor(0)!="PRETO" && bc.ReturnColor(4) != "PRETO"){
      ...
      else if(bc.DetectDistance(2,20,25)){ //RAMPA
    ...
    if(bc.ReturnColor(0) == "PRETO" && bc.ReturnColor(2) == "PRETO" && bc.ReturnColor(1) == "PRETO" && bc.ReturnColor(3) == "BRANCO" && bc.ReturnColor(4) ==  "BRANCO"){
      curvasDe90(1, 14, 0);
    }else if(bc.ReturnColor(0) == "BRANCO" && bc.ReturnColor(2) == "PRETO" && bc.ReturnColor(1) == "BRANCO" && bc.ReturnColor(3) == "PRETO" && bc.ReturnColor(4) ==  "PRETO"){
      curvasDe90(-1, 14, 0);
    };
    //MARCAÇÕES VERDES
    if(bc.ReturnColor(1) == "VERDE" && bc.ReturnColor(3) == "BRANCO"){
      curvasDe90(1, 15, 1);
